...
REQUIRED_PACKAGE_FILES = {
    ...
    "tradingagents/delivery/templates/email/operational_alert.j2",
    ...
    "tradingagents/delivery/templates/telegram/operational_alert.j2",
    ...
    "tradingagents/persistence/migrations/0006_operator_observability.sql",
